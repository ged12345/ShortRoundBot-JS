...
/* There should be two seperate Queues - the original Queue functionlity and a ParallelQueuer. Too much functionality in the one class and we only run everything in parallel now anyway*/
